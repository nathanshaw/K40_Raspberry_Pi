...
if __name__ == '__main__':
    ...
    try:
        ...
        while True:
            ...
            theaterChase(strip, neopixel.Color(127, 127, 127))  # White theater chase
            theaterChase(strip, neopixel.Color(127,   0,   0))  # Red theater chase
            theaterChase(strip, neopixel.Color(  0,   0, 127))  # Blue theater chase
